    ...
    <main class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 my-4">
                <img src="./assets/img/<?= ('poster/' . $dadosFilmes['poster']) ?>" alt="poster Jedi Survivor" class="foto ">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 detalhe-produto py-5">
                <h1 class="titulo-jogo"><?= $dadosFilmes['nome'] ?></h1>
                ...
                <h3 class="preco">R$ <?= number_format($dadosFilmes['valor_ingresso'], 2, ',', '.') ?></h3>
                ...
                <form action="" method="post">
                    <input type="hidden" name="id_produto" value="<?= $dadosFilmes['id'] ?>">
                ...
                <div class="sobre-filme">
                    <h4>Descrição</h4>
                    <?php
                    $descricao = explode('. ', $dadosFilmes['descricao']);
